...
capture eligibility and emits source assertions; it does not resolve canonical
listings, convert amounts, allocate stream positions, or mutate market state.
