...
struct RiskScopeIdTag;
struct RiskObligationIdTag;
struct RiskDecisionIdTag;
struct RiskEvaluationOutcomeIdTag;
struct ProjectedExposureIdTag;
...
using RiskScopeId = OpaqueId<RiskScopeIdTag>;
using RiskObligationId = OpaqueId<RiskObligationIdTag>;
using RiskDecisionId = OpaqueId<RiskDecisionIdTag>;
using RiskEvaluationOutcomeId = OpaqueId<RiskEvaluationOutcomeIdTag>;
using ProjectedExposureId = OpaqueId<ProjectedExposureIdTag>;
