.PHONY: bootstrap module-stubs-check strategy-capability-check m5-authority-check m6-authority-check m6-risk-authority-check cpp-build cpp-test cpp-format cpp-check cpp-profiles-check python-build python-test python-lint python-format python-check m0-round-trip m0-check m0-gate-proof m1-conformance
...
m5-authority-check:
	python3 tools/development/verify_m5_authority_boundaries.py

m6-authority-check:
	python3 tools/development/verify_m6_authority_boundaries.py

m6-risk-authority-check:
...
m0-check: module-stubs-check strategy-capability-check m5-authority-check m6-authority-check m6-risk-authority-check cpp-check python-check
